...
//
// Modified to rust by Drazi Crendraven
// Original work by Ladislav Zezula
///
use nodejs_sys::{napi_callback_info, napi_create_int32, napi_env, napi_value};

//-----------------------------------------------------------------------------
// Defines

// The longest allowed repetition
static MAX_REP_LENGTH: i32 = 0x204;

//-----------------------------------------------------------------------------
// Tables

static DIST_BITS: [i32; 64] = [
...
static EX_LEN_BITS: [i32; 16] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
];

static LEN_BITS: [i32; 16] = [
    0x03, 0x02, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07,
];

static LEN_CODE: [i32; 16] = [
    0x05, 0x03, 0x01, 0x06, 0x0A, 0x02, 0x0C, 0x14, 0x04, 0x18, 0x08, 0x30, 0x10, 0x20, 0x40, 0x00,
];

static CH_BITS_ASC: [i32; 256] = [
...
pub unsafe extern "C" fn implode(env: napi_env, _info: napi_callback_info) -> napi_value {
    ...
    napi_create_int32(env, MAX_REP_LENGTH, &mut local);
